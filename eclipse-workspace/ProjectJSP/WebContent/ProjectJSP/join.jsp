...
return joinOk.jsp when input values and submit.
 -->
    ...
    <div class="container" align="center">
        <div id="center" align="center">
            ...
            <table id="inputData">
                <tr>
                    <th >ID</th>
                    <td colspan="3"><input type="text" name="userID" placeholder="ID를 입력하세요." style="width:85%; max-width: 800px; background-color: rgba(255, 255, 255, 0.2); height: 25px;"></td>
                </tr>
                <tr>
                    <td colspan="4">
                        <hr style="border-bottom-color: red; width: 90%; ">
                ...
                <tr>
                    <th>PW</th>
                    <td colspan="3"><input type="password" name="pw" placeholder="비밀 번호를 입력하세요." style="width:85%; max-width: 800px; background-color: rgba(255, 255, 255, 0.2); height: 25px;"></td>
                </tr>
                <tr>
                    <td colspan="4">
                        <hr style="border-bottom-color: red; width: 90%">
                ...
                <tr>
                    <th>confirm<br>PW</th>
                    <td colspan="3"><input type="password" name="pw_check" placeholder="비밀번호를 다시 입력하세요." style="width:85%; max-width: 800px; background-color: rgba(255, 255, 255, 0.2); height: 25px;"></td>
                </tr>
                <tr>
                    <td colspan="4">
                        <hr style="border-bottom-color: red; width: 90%">
                ...
                <tr>
                    <th >Name</th>
                    <td colspan="3"><input type="text" name="name" placeholder="이름을 입력하세요." style="width:85%; max-width: 800px;background-color: rgba(255, 255, 255, 0.2); height: 25px;"></td>
                </tr>
                <tr>
                    <td colspan="4">
                        <hr style="border-bottom-color: red; width: 90%">
                ...
                <tr>
                    <th >Email</th>
                    <td colspan="3"><input type="email" name="email" placeholder="이메일을 입력하세요." style="width:85%; max-width: 800px; background-color: rgba(255, 255, 255, 0.2); height: 25px;"></td>
                </tr>
                <tr>
                    <td colspan="4">
                        <hr style="border-bottom-color: red; width: 90%">
                ...
                <tr>
                   <th>Age</th>
                   <td><input type="number" name ="age" placeholder="나이를 입력하세요." style="background-color: rgba(255, 255, 255, 0.2); height: 25px;"></td>
                   <th>gender</th>
