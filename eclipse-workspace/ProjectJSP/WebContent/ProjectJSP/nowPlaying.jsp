<!-- 
This page is show now playing movie.
 -->
...
<%
	...
	final int TOTAL = dao.getNowPlayingTotal();
	...
	<div class="container" align="center">
		<div id="center" align="center">
			<table align="center" id="listmovie" style="width: 90%;">
				<%
					ArrayList<MovieDTO> now = dao.getNowPlaying(start, end);
					for (MovieDTO dto : now) {
				%>
							...
							<table style="width: 100%;">
								<tr>
									<th colspan="2"><a
										...
										style="color: black; text-decoration: none;"><%=dto.getRank()%>.&nbsp;<%=dto.getName()%></a></th>
								</tr>
								<tr>
									<td colspan="2"
								...
								<tr>
									<td style="background-color:">예매율</td>
			...
			<script language="javascript">
				function pageClick(page) {
					document.location.href = 'nowPlaying.jsp?page=' + page;
					return;
				}
			</script>
